    ...
    return (
        <div className='card'>
            ...
            <div className='info-block'>
                ...
                <br/>
                <br/>
                In my github you will find the project of this <span id='github-repository'><a href='https://github.com/TheBrodaCoder/TigerWeb' target='_blank' rel='noreferrer'>website</a></span>, as well as different projects and deliveries. I love to keep working and learning, so you'll probably see some activity!
                <br/>
                <br/>
